			...
			<div class="content">
				...
				<div class="pieces-slider">
					...
					<div class="pieces-slider__slide">
						<img class="pieces-slider__image" src="img/star1.jpg" alt="">
						<h2 class="pieces-slider__text">Darshan Raval</h2>
					</div>
					<div class="pieces-slider__slide">
						<img class="pieces-slider__image" src="img/star2.jpg" alt="">
						<h2 class="pieces-slider__text">DJ Moctave</h2>
					</div>
					<!-- <div class="pieces-slider__slide">
